        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoordNorth = table.Column<string>(type: "varchar(10)", nullable: false),
                    CoordSouth = table.Column<string>(type: "varchar(10)", nullable: false),
                    City = table.Column<string>(type: "varchar(40)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaterStorages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phosphates = table.Column<float>(type: "real", nullable: false),
                    Ferrum = table.Column<float>(type: "real", nullable: false),
                    Nitrates = table.Column<float>(type: "real", nullable: false),
                    Nitrities = table.Column<float>(type: "real", nullable: false),
                    SuspendedSolids = table.Column<float>(type: "real", nullable: false),
                    WaterStorageId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Measurements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Measurements_WaterStorages_WaterStorageId",
                        column: x => x.WaterStorageId,
                        principalTable: "WaterStorages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Measurements_WaterStorageId",
                table: "Measurements",
                column: "WaterStorageId");
        }
